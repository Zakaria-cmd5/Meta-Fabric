import innofi from "../../assets/InooFi.png";

const InnoFiSection = () => {
  return (
    <div className="bg-gray-400 grid grid-cols-1 md:grid-cols-2 p-4 gap-4 mt-20">
      {/* Text Section */}
      ...
      <div className="flex justify-center items-center">
        <img
          src={innofi}
          alt="InnoFi"
          className="w-full max-w-xs sm:max-w-md lg:max-w-lg object-contain rounded-xl shadow-lg"
        />
      </div>
    </div>
  );
